      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-stone-900 p-6 rounded-lg border border-amber-900/50 flex flex-col items-center text-center hover:border-amber-700 transition-colors">
            ...
            <h4 class="text-xl font-bold mb-2 text-amber-400">Premium Products</h4>
            <p class="text-amber-200/70">
              We use only the finest grooming products, many of which are handcrafted and exclusive to our shop.
            </p>
          </div>
          ...
          <div class="bg-stone-900 p-6 rounded-lg border border-amber-900/50 flex flex-col items-center text-center hover:border-amber-700 transition-colors">
            ...
            <h4 class="text-xl font-bold mb-2 text-amber-400">Community Focus</h4>
            <p class="text-amber-200/70">
              More than a barbershop, we're a gathering place for gentlemen who appreciate quality and camaraderie.
            </p>
          </div>
        </div>
      </div>
